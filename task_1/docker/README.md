...
- O servidor espera os arquivos de nome `selfsigned.crt` e `selfsigned.key` na pasta `task_1/certs`.
...
openssl req -newkey rsa:4096 \
            ...
            -days 3650 \
            -nodes \
            -out task_1/certs/selfsigned.crt \
            -keyout task_1/certs/selfsigned.key
```
